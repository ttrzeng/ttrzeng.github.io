...
export const DATA = {
  ...
  projects: [
    {
      title: "LeadsByLocation",
      href: "https://leadsbylocation.com/",
      dates: "2025 - Present",
      active: true,
      description:
        "A tool that helps freelancers and agencies find local business leads instantly. Search by city to get contact info, website scores, and outreach angles — built for people who sell web design, SEO, and marketing services.",
      technologies: [
        "React",
        "Typescript",
        "Supabase",
