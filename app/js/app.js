...
TalentPage.$inject = ['$stateProvider', '$urlRouterProvider', '$locationProvider'];

angular.module("TalentPage").config('TalentPage', TalentPage);

	function TalentPage($stateProvider, $urlRouterProvider, $locationProvider){
